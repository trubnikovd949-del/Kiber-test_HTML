...
// Расширенный список простых вопросов
const questions = [
  {
  ...
  {
    question: "Что делает строка: margin: 0; ?",
    answers: [
  ...
  },
  {
    ...
    answers: [
      "Центрирует весь блок на странице",
  ...
  {
    question: "Что означает font-family в CSS?",
    answers: [
      "Размер шрифта",
      "Цвет текста",
      "Тип (начертание) шрифта",
      "Жирность текста"
    ],
    correct: 2
  },
  {
    question: "Как правильно добавить изображение на страницу?",
    answers: [
      "<img src='картинка.jpg'>",
      "<picture='картинка.jpg'>",
      "<image src='картинка.jpg'>",
      "<src img='картинка.jpg'>"
    ],
    correct: 0
  }
];
